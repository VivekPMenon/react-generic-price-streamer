...
export const CorporateActionHeader = () => {
    ...
    const filterConfig: FilterConfigItem[] = [
        {
          key: "actionType",
          label: i18n.t('corporate_actions_1.action_type'),
          type: "dropdown",
          options: [
        ...
        {
          key: "securityTicker",
          label: i18n.t('corporate_actions_1.security_ticker'),
          type: "dropdown",
        ...
        },
        {
          ...
          label:  i18n.t('corporate_actions_1.isin_cusip'),
          type: "dropdown",
        ...
        {
          key: "dateRange",
          label: i18n.t('corporate_actions_1.date_range'),
          type: "date",
        },
        {
          key: "corpActionId",
          label: i18n.t('corporate_actions_1.corp_action_id'),
          type: "dropdown",
        ...
        {
          key: "eventStatus",
          label: i18n.t('corporate_actions_1.event_status'),
          type: "dropdown",
        ...
        {
          key: "eventType",
          label: i18n.t('corporate_actions_1.event_type'),
          type: "dropdown",
        ...
        {
          key: "account",
          label: i18n.t('corporate_actions_1.account'),
          type: "dropdown",
            ...
            <section className='flex gap-[30px] items-center mb-3 md:flex-row flex-col'>
                <div className={`${styles['search-bar']} flex-1 w-full md:w-1/2`}>
                    <input
                        ...
                        placeholder={i18n.t('corporate_actions_1.search_placeholder')} />
                    {
                ...
                <div className='flex-1 w-full md:w-1/2'>
                    <div className='flex gap-4'>
                        <div className='flex items-center gap-2'>
                            <label htmlFor='sort-action'>{i18n.t('corporate_actions_1.sort_by_action_required')}</label>
                            <Toggle
                            id='sort-action'
                        ...
                        onClick={handleReset}
                        >
                         {i18n.t('corporate_actions_1.reset')}
                        </button>
                    </div>
                </div>
            </section>
